    ...
    <>
      ...
      <header className="fixed top-5 md:top-8 left-0 right-0 z-50 flex justify-center px-4 md:px-6 pointer-events-none">
        <div className="relative w-full max-w-[840px]">
          ...
          <div className="pointer-events-auto relative overflow-hidden flex w-full items-center justify-between rounded-full border border-black/[0.05] dark:border-white/[0.08] bg-white/30 dark:bg-white/[0.04] py-2 px-5 md:px-6 shadow-[0_12px_36px_rgba(0,0,0,0.05),0_1px_2px_rgba(0,0,0,0.02),inset_0_1px_1.5px_0_rgba(255,255,255,0.45),inset_0_-1px_1px_0_rgba(255,255,255,0.1),inset_0_0_16px_rgba(255,255,255,0.05)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.45),0_1px_2px_rgba(0,0,0,0.2),inset_0_1px_1.5px_0_rgba(255,255,255,0.18),inset_0_-1px_1px_0_rgba(255,255,255,0.03)] backdrop-blur-3xl backdrop-saturate-200 backdrop-brightness-105 transition-all">
            
            {/* Top Specular Rim Reflection - Subtle */}
            <div className="pointer-events-none absolute inset-x-12 top-0 h-[1px] bg-gradient-to-r from-transparent via-white/45 dark:via-white/20 to-transparent" />
